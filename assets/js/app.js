...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger-menu').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.block-mobile-menu').addClass('show-menu');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('hidden');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.close-btn').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.block-mobile-menu').removeClass('show-menu');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger-menu').removeClass('hidden');
  }); //smooth scroll anchor

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('a[href^="#"]').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('html, body').animate({
      scrollTop: jquery__WEBPACK_IMPORTED_MODULE_0___default()('[id="' + jquery__WEBPACK_IMPORTED_MODULE_0___default.a.attr(this, 'href').substr(1) + '"]').offset().top
    }, 1000);
    return false;
  });
  var scrollPos = 0;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.popup-form').on('click', function (e) {
    // e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.form-popup').addClass('show-popup');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.overlay-popup ').addClass('show-over');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.show-popup form').css({
      display: 'flex'
    });
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.overlay-popup, .close-btn-form').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.form-popup').removeClass('show-popup');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.overlay-popup ').removeClass('show-over');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.success-form').css({
      display: 'none'
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").css({
      overflow: "",
    ...
    if (scrollPos != 0) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop(scrollPos);
    }
  });
});
jQuery(document).ready(function ($) {
  ...
  $('#form-input-subcs').on('submit', function () {
    var form = $(this);
    $.ajax({
      url: 'mail-subsc.php',
      type: "POST",
      ...
      success: function success(result) {
        $('.form-subsc-success p').css({
          display: 'block'
        });

        var explode = function explode() {
          $('.form-subsc-success p').fadeOut(700);
        };

        setTimeout(explode, 5000);
        $('.block-mail #email').val('');
      }
    }); // Prevents default submission of the form after clicking on the submit button.
...
module.exports = __webpack_require__(/*! D:\openserver\OSPanel\domains\Crafter\src\assets\js\app.js */"./src/assets/js/app.js");
